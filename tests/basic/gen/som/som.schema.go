...
DEFINE FIELD uint ON TABLE all_field_types TYPE number ASSERT $value >= 0dec AND $value <= 18446744073709551615dec;
DEFINE FIELD uint_ptr ON TABLE all_field_types TYPE option<number | null> ASSERT $value == NONE OR $value == NULL OR $value >= 0dec AND $value <= 18446744073709551615dec;
...
DEFINE FIELD uint_64 ON TABLE all_field_types TYPE number ASSERT $value >= 0dec AND $value <= 18446744073709551615dec;
DEFINE FIELD uint_64_ptr ON TABLE all_field_types TYPE option<number | null> ASSERT $value == NONE OR $value == NULL OR $value >= 0dec AND $value <= 18446744073709551615dec;
DEFINE FIELD uintptr ON TABLE all_field_types TYPE number ASSERT $value >= 0dec AND $value <= 18446744073709551615dec;
DEFINE FIELD uintptr_ptr ON TABLE all_field_types TYPE option<number | null> ASSERT $value == NONE OR $value == NULL OR $value >= 0dec AND $value <= 18446744073709551615dec;
