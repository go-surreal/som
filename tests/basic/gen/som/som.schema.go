...
DEFINE FIELD slice_slice.* ON TABLE all_field_types TYPE option<array | null>;
DEFINE FIELD byte ON TABLE all_field_types TYPE string ASSERT $value != NULL;
DEFINE FIELD byte_ptr ON TABLE all_field_types TYPE string;
DEFINE FIELD byte_slice ON TABLE all_field_types TYPE option<array | null>;
DEFINE FIELD byte_slice.* ON TABLE all_field_types TYPE string ASSERT $value != NULL;
DEFINE FIELD byte_slice_ptr ON TABLE all_field_types TYPE option<array | null>;
DEFINE FIELD byte_slice_ptr.* ON TABLE all_field_types TYPE string ASSERT $value != NULL;
