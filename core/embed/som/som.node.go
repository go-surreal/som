...
func (r *repo[N, C]) read(ctx context.Context, id *sdbc.ID) (*N, bool, error) {
...
func (r *repo[N, C]) update(ctx context.Context, id *sdbc.ID, node *N) error {
	data := r.convFrom(node)
...
func (r *repo[N, C]) delete(ctx context.Context, id *sdbc.ID, node *N) error {
