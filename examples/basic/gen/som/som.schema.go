...
DEFINE FIELD struct_slice.*.int_ptr ON TABLE user TYPE option<int | null> ASSERT $value == NONE OR $value == NULL OR $value >= -9223372036854775808 AND $value <= 9223372036854775807;
