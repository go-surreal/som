...
DEFINE FIELD created_at ON TABLE user TYPE option<datetime> VALUE $before OR time::now();
DEFINE FIELD updated_at ON TABLE user TYPE option<datetime> VALUE time::now();
