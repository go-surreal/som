...
DEFINE FIELD struct_ptr.uuid_ptr ON TABLE user TYPE option<string>;
...
DEFINE FIELD struct_ptr_slice.*.uuid_ptr ON TABLE user TYPE option<string>;
...
DEFINE FIELD struct_ptr_slice_ptr.*.uuid_ptr ON TABLE user TYPE option<string>;
