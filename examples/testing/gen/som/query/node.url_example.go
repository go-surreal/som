...
func (q URLExample) Filter(filters ...lib.Filter[model.URLExample]) URLExample {
...
func (q URLExample) Order(by ...*lib.Sort[model.URLExample]) URLExample {
	for _, s := range by {
...
func (q URLExample) Fetch(fetch ...with.Fetch_[model.URLExample]) URLExample {
	for _, f := range fetch {
...
func (q URLExample) Timeout(timeout time.Duration) URLExample {
...
func (q URLExample) Parallel(parallel bool) URLExample {
...
func (q URLExample) Count(ctx context.Context) (int, error) {
...
func (q URLExample) CountAsync(ctx context.Context) *asyncResult[int] {
...
func (q URLExample) Exists(ctx context.Context) (bool, error) {
...
func (q URLExample) ExistsAsync(ctx context.Context) *asyncResult[bool] {
	return async(ctx, q.Exists)
}

// All returns all records matching the conditions of the query.
func (q URLExample) All(ctx context.Context) ([]*model.URLExample, error) {
...
func (q URLExample) AllAsync(ctx context.Context) *asyncResult[[]*model.URLExample] {
	return async(ctx, q.All)
}

// AllIDs returns the IDs of all records matching the conditions of the query.
func (q URLExample) AllIDs(ctx context.Context) ([]string, error) {
...
func (q URLExample) AllIDsAsync(ctx context.Context) *asyncResult[[]string] {
...
func (q URLExample) First(ctx context.Context) (*model.URLExample, error) {
	q.query.Limit = 1
	res, err := q.All(ctx)
	if err != nil {
		return nil, err
...
func (q URLExample) FirstAsync(ctx context.Context) *asyncResult[*model.URLExample] {
...
// This comes in handy when using a filter for a field with unique values or when
// sorting the result set in a specific order where only the first result is relevant.
func (q URLExample) FirstID(ctx context.Context) (string, error) {
	q.query.Limit = 1
...
func (q URLExample) FirstIDAsync(ctx context.Context) *asyncResult[string] {
...
func (q URLExample) Describe() string {
	req := q.query.BuildAsAll()
