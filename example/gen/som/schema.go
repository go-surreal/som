...
DEFINE FIELD groups ON TABLE user TYPE array ASSERT $value != NULL;
DEFINE FIELD groups.* ON TABLE user TYPE record(group) ASSERT $value != NULL;
DEFINE FIELD main_group ON TABLE user TYPE record(group) ASSERT $value != NULL;
DEFINE FIELD other ON TABLE user TYPE array ASSERT $value != NULL;
DEFINE FIELD other.* ON TABLE user TYPE string ASSERT $value != NULL;
DEFINE FIELD more ON TABLE user TYPE array ASSERT $value != NULL;
DEFINE FIELD more.* ON TABLE user TYPE float ASSERT $value != NULL;
DEFINE FIELD roles ON TABLE user TYPE array ASSERT $value != NULL;
...
DEFINE FIELD string_ptr_slice ON TABLE user TYPE array ASSERT $value != NULL;
...
DEFINE FIELD struct_ptr_slice ON TABLE user TYPE array ASSERT $value != NULL;
...
DEFINE FIELD enum_ptr_slice ON TABLE user TYPE array ASSERT $value != NULL;
DEFINE FIELD enum_ptr_slice.* ON TABLE user TYPE string;
DEFINE FIELD node_ptr_slice ON TABLE user TYPE array ASSERT $value != NULL;
...
DEFINE FIELD slice_slice ON TABLE user TYPE array ASSERT $value != NULL;
DEFINE FIELD slice_slice.* ON TABLE user TYPE array ASSERT $value != NULL;
