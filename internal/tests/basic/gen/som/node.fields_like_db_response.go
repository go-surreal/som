...
type FieldsLikeDBResponseRepo interface {
	...
	Read(ctx context.Context, id *sombase.ID) (*model.FieldsLikeDBResponse, bool, error)
...
func (r *fieldsLikeDbresponse) Read(ctx context.Context, id *sombase.ID) (*model.FieldsLikeDBResponse, bool, error) {
