...
func (r *allFieldTypes) Create(ctx context.Context, allFieldTypes *model.AllFieldTypes) error {
	...
	if h, ok := any(allFieldTypes).(som.OnBeforeCreateHook); ok {
	...
	if h, ok := any(allFieldTypes).(som.OnAfterCreateHook); ok {
...
func (r *allFieldTypes) Update(ctx context.Context, allFieldTypes *model.AllFieldTypes) error {
	...
	if h, ok := any(allFieldTypes).(som.OnBeforeUpdateHook); ok {
	...
	if h, ok := any(allFieldTypes).(som.OnAfterUpdateHook); ok {
...
func (r *allFieldTypes) Delete(ctx context.Context, allFieldTypes *model.AllFieldTypes) error {
	...
	if h, ok := any(allFieldTypes).(som.OnBeforeDeleteHook); ok {
	...
	if h, ok := any(allFieldTypes).(som.OnAfterDeleteHook); ok {
